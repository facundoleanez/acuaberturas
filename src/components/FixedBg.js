...
import video from '../video/acuaberturas.mp4'
                    ...
                    <div className="container" >
                        <div className="row justify-content-center">
                            <div className="col-8  shadow-lg p-3 m-5" style={{backgroundColor: "rgba(17, 77, 114, 0.507)"}}>
                                <h1>Nosotros</h1>
                                <video className="container" src={video} autoplay controls></video>
                                ...
                                <button className="btn btn-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseText" aria-expanded="false" aria-controls="collapseText">Leer mas</button>
                                <div className="collapse mt-3" id="collapseText">
                                    <p><strong>CARPINTERÍA DE ALUMINIO</strong> Contamos con la más alta calidad de productos y tecnología debido a que nos ocupamos de seleccionar empresas líderes en el rubro, tales como METALES DEL TALAR , HYDRO y BLINDEX, los cuáles nos permiten fabricar productos competitivos por la excelencia de su elaboración y calidad.</p>
